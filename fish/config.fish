...
SET fish_color_cwd:af00d7
SET fish_color_cwd_root:af005f
SET fish_color_error:red\x1e\x2d\x2dbold
SET fish_color_escape:cyan
SET fish_color_git_clean:ffff87
SET fish_color_git_staged:ffff00
SET fish_color_history_current:cyan
SET fish_color_host:00ff00
